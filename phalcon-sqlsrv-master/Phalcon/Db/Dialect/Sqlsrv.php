 ...
 */
class Sqlsrv extends Dialect// implements \Phalcon\Db\DialectInterface
{
    /**
     * Escape Char.
     *
...
//                }
     ...
     * @return string
     */
    public function dropTable(string $tableName, string $schemaName = null, $ifExists = true): string
    {
        $table = $this->prepareTable($tableName, $schemaName);
